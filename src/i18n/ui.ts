export const ui = {
  ...
  'zh': {
    ...
    contributionYear: '过去的 365 天贡献 {n} 次',
    contributionUnavailable: '贡献数据不可用',
    glossaryTitle: '术语表',
    glossaryDesc: '术语表收录了本站文章中出现的专业技术术语。当术语首次出现在非周刊文章中时，会自动链接到维基百科对应条目，方便读者快速了解概念背景。术语表持续更新，当前共收录 {n} 条术语。',
  ...
  'zh-tw': {
    ...
    contributionYear: '過去的 365 天貢獻 {n} 次',
    contributionUnavailable: '貢獻數據不可用',
    glossaryTitle: '術語表',
    glossaryDesc: '術語表收錄了本站文章中出現的專業技術術語。當術語首次出現在非週刊文章中時，會自動連結到維基百科對應條目，方便讀者快速了解概念背景。術語表持續更新，當前共收錄 {n} 條術語。',
    glossaryLetterNav: '字母索引',
