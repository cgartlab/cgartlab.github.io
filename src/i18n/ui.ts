export const ui = {
  ...
  'zh': {
    ...
    description:
      'CG艺术实验室（cgartlab.com）是一个专注于数字艺术、视觉设计、技术分享和知识管理的视觉设计机构。致力于为数字艺术爱好者、专业设计师和初学者以及商业客户，提供最新、最全面的资讯、教程、作品展示以及设计服务。',
    posts: '文章',
    tags: '标签',
    about: '关于',
    works: '作品',
    ...
    glossaryTitle: '术语表',
    glossaryDesc:
      '术语表收录了本站文章中出现的专业技术术语。当术语首次出现在非专栏文章中时，会自动链接到维基百科对应条目，方便读者快速了解概念背景。术语表由人工维护，并非每篇文章中的所有术语都会收录，部分条目也可能滞后于最新文章。当前共收录 {n} 条术语。',
  ...
  'zh-tw': {
    ...
    description:
      'CG藝術實驗室（cgartlab.com）是一個專注於數位藝術、視覺設計、技術分享和知識管理的視覺設計機構。致力於為數位藝術愛好者、專業設計師和初學者以及商業客戶，提供最新、最全面的資訊、教程、作品展示以及設計服務。',
    posts: '文章',
    tags: '標籤',
    about: '關於',
    works: '作品',
    ...
    glossaryTitle: '術語表',
    glossaryDesc:
      '術語表收錄了本站文章中出現的專業技術術語。當術語首次出現在非專欄文章中時，會自動連結到維基百科對應條目，方便讀者快速了解概念背景。術語表由人工維護，並非每篇文章中的所有術語都會收錄，部分條目也可能滯後於最新文章。當前共收錄 {n} 條術語。',
    glossaryLetterNav: '字母索引',
