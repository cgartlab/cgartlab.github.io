...
CG艺术实验室（以下简称"本站"）高度重视用户的隐私保护。本隐私政策旨在向您说明，当您访问本站时，我们收集哪些信息、如何使用这些信息以及您享有的相关权利。
...
| Umami Analytics | Umami Software, Inc. | 开源网站分析（自托管/隐私友好） | [Umami 隐私政策](https://umami.is/privacy) |
...
- **本站设置**：首次访问时的 Cookie 同意横幅（如适用）
- **分析工具退出**：
  - [Google Analytics 退出](https://tools.google.com/dlpage/gaoptout)

**注意**：禁用必要 Cookie 可能影响本站的正常功能（如主题切换记忆）。
...
- 本站托管于 GitHub Pages（美国），部分访问数据可能传输至境外服务器
- Google Analytics 数据处理可能涉及跨境传输
- 我们确保所有跨境传输均符合中国法律法规要求，并采取充分的安全保护措施
