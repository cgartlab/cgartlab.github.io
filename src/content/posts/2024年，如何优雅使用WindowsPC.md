...
![Windows 11 优雅使用指南封面图，展示现代化的桌面环境和简洁的工作空间](./_images/2024年，如何优雅使用WindowsPC-1754581781794.webp)
...
![Windows输入法U模式生僻字输入演示，展示如何通过U模式输入"叕"字](./_images/2024年，如何优雅使用WindowsPC-1754582328874.gif)

还有一个**V 模式计算器，**例如输入"v12*15"，输出的直接就是计算结果了。

![Windows输入法V模式计算器演示，展示如何通过V模式进行"12*15"计算](./_images/2024年，如何优雅使用WindowsPC-1754582360423.gif)
...
![Windows 11电源选项高级设置界面，展示处理器电源管理配置](./_images/2024年，如何优雅使用WindowsPC-1754582435322.webp)

![Windows 11电源选项中的系统散热策略设置界面](./_images/2024年，如何优雅使用WindowsPC-1754582444233.webp)

![Windows 11电源选项中的处理器电源管理最小处理器状态设置](./_images/2024年，如何优雅使用WindowsPC-1754582472409.webp)

![Windows 11电源选项中的处理器电源管理最大处理器状态设置](./_images/2024年，如何优雅使用WindowsPC-1754582537239.webp)
...
![任务管理器启动选项卡界面，展示如何管理开机启动项](./_images/2024年，如何优雅使用WindowsPC-1754582592773.webp)
...
![Windows存储感知设置界面，展示自动清理临时文件和回收站的功能](./_images/2024年，如何优雅使用WindowsPC-1754582614613.webp)
...
![微软电脑管家主界面，展示系统清理和安全防护功能](./_images/2024年，如何优雅使用WindowsPC-1754582630960.webp)

### 磁盘优化

相比垃圾文件，定期进行磁盘优化在我看来可以更好地帮助改善你的电脑性能。你可以在"设置" - "系统" - "存储" - "优化驱动器"里找到这个功能。选择你想要优化的驱动器，然后点击"优化"就可以开始了。也可以设置定期优化的周期。

![Windows磁盘优化工具界面，展示驱动器分析和优化功能](./_images/2024年，如何优雅使用WindowsPC-1754582651970.webp)

### 配置虚拟内存

虚拟内存是一种让电脑使用硬盘空间作为临时 RAM 的技术。当同时打开的程序太多，物理内存不够了，系统就会使用一部分硬盘空间来存放这些数据。硬盘当然没有内存快，所以开多了程序自然会卡。

![Windows虚拟内存设置界面，展示如何自定义页面文件大小](./_images/2024年，如何优雅使用WindowsPC-1754582710312.gif)
...
正如在之前《[流水的程序，铁打的数据](https://cgartlab.com/posts/flow-program-iron-data/)》里提到过，对于目录结构和文件管理我定下的核心原则：

> **非必要不增加分类：**前提是这个分类可以穷尽，例如文件类型无非是那么几种，但格式有无数种。
> **1 分钟内完成归档：**我见过很多人知道归档很重要，但能坚持一年都很少，很多情况是刚做完工作已经很烦躁疲惫了，哪儿还有趣味费那个劲？其实真正做好了分类，1 分钟归档是水到渠成的事情。
...
值得注意的是，Windows 11 对窗口管理做了很多优化，只要把一个窗口拖到屏幕上边附近，就会显示出预设好的窗口尺寸，99% 的软件都会很好的适配这个功能。相比之前的版本，也有了更多分组选择。

![Windows 11窗口贴靠功能演示，展示如何通过拖拽窗口到屏幕边缘实现自动分屏](./_images/2024年，如何优雅使用WindowsPC-1754582768724.gif)
...
![Windows 11虚拟桌面切换演示，展示如何创建和切换不同的工作空间](./_images/2024年，如何优雅使用WindowsPC-1754582836076.gif)
...
![uTools启动器界面演示，展示如何通过快捷键快速搜索和启动应用程序](./_images/2024年，如何优雅使用WindowsPC-1754582885032.gif)
...
![Traffic Monitor 硬件监控工具界面，展示CPU、内存、网络使用率和温度](./_images/2024年，如何优雅使用WindowsPC-1754582962998.webp)
...
![Quicklook文件预览工具演示，展示如何通过空格键快速查看文件内容](./_images/2024年，如何优雅使用WindowsPC-1754583117080.gif)

一款借鉴 macOS 空格预览工具，选中任意一个文件按下空格直接查看文件内容。常用于快速查看图片视频和文本文档。

[Twinkle Tray](https://twinkletray.com/)：**键盘调节屏幕亮度**

![Twinkle Tray屏幕亮度调节工具演示，展示如何通过快捷键或鼠标滚轮调整显示器亮度](./_images/2024年，如何优雅使用WindowsPC-1754582989660.gif)
...
![Fluent Reader RSS阅读器界面，展示简洁的阅读界面和订阅源管理](./_images/2024年，如何优雅使用WindowsPC-1754583001340.webp)
...
![Windows终端命令行界面演示，展示常用系统命令的使用方法](./_images/2024年，如何优雅使用WindowsPC-1754583026082.gif)
...
![Windows Hyper-V虚拟机管理器界面，展示如何创建和管理虚拟机](./_images/2024年，如何优雅使用WindowsPC-1754583037058.webp)
