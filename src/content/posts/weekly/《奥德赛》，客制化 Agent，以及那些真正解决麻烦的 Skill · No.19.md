...
![本期封面拍摄自泰国春武里西昌岛，那里的夏天似乎永远不会结束。](../_images/那些真正解决麻烦的%20Skill%20·%20No.19-1788084531668.webp)
...
![](../_images/《奥德赛》，客制化%20Agent，以及那些真正解决麻烦的%20Skill%20·%20No.19-1788180756727.webp)
...
名字暂定叫作 [Men](https://men.cgartlab.com) 。是一套最初我自己用的定制化 Agent 团队，但这个不适合在这里展开写，之后会单开一篇详细介绍。

总之，这是使用 AI 这几年以来对我自己而言的一个里程碑事件，所谓「磨刀不误砍柴工」。

**收到了少数派征文奖品，声擎 Cyber 5**

![](../_images/《奥德赛》，客制化%20Agent，以及那些真正解决麻烦的%20Skill%20·%20No.19-1788180893773.webp)
...
**affine-cli**： 这个 skill 是用来辅助编辑 Affine 的文档。Affine 是一个类似 Notion 的竞品，优势是可以使用 Docker 自部署，目前我自己的工作流已经用它完全取代了 Notion。虽然 Notion 有更强大的数据库 AI 功能，但国内的访问效率支付方式依然不够友好，并且很多涉密的项目信息直接不能放在上面，遂弃。
...
3. **利用互联网基础设施作为工具，沉淀这些承载新型信息和数据。** 基础设施是不会轻易变革的，例如邮件，Git，IP 地址，区块链，网站，markdown 语法。
